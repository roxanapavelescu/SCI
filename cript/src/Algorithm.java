...
public class Algorithm {
     ...
     */
    public String DESdecrypt(String key, String plaintext) {
    ...
    public static void main(String[] args) throws Exception, BadPaddingException, IllegalBlockSizeException {
        ...
        /* Get back here and make those below modular if time (different classes for every algorithm, keep only
        the input function here maybe)
        */
        ...
        long estimatedTime = System.nanoTime() - startTime;
        System.out.println("AES encrypting time in nanoseconds : " + estimatedTime);
        ...
        System.out.println("AES decrypting time in nanoseconds : " + estimatedTime);
        ...
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("Blowfish encrypting time in nanoseconds : " + estimatedTime);
        ...
        byte[] message1 = cipher.doFinal(ciphertext);
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("Blowfish decrypting time in nanoseconds : " + estimatedTime);
        System.out.println("-- Decrypted blowfish -----------");
        System.out.println("HEX:\t " + bytesToHex(message1));
        System.out.println("PLAIN:\t " + new String(message1));
        System.out.println();

        System.out.println("Start of RSA");
        startTime = System.nanoTime();
        ...
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("RSA encrypting time in nanoseconds : " + estimatedTime);
        System.out.println("RSA encrypted: " + ciphertext1);
        startTime = System.nanoTime();
        plaintext = rsa.RSAdecrypt(ciphertext1);
        String text2 = new String(plaintext.toByteArray());
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("RSA decrypting time in nanoseconds : " + estimatedTime);
        System.out.println("RSA decrypted: " + text2);



     /*  System.out.println("Start of DES");
        Algorithm des = new Algorithm();
        String t = "his is a secret message being encrypted by DES and isn't it awesome that it finally works?";

        String keyDes = "secretkey";
        startTime = System.nanoTime();
        String DEScipher = des.DESencrypt(keyDes, t);
        estimatedTime = System.nanoTime() - startTime;

        System.out.println("DES Plaintext: " + "This is the message we really want to encrypt");
        System.out.println("DES encrypting time in nanoseconds : " + estimatedTime);

        System.out.println("Encrypting message with key: 'secretkey'\nMessage:\n" +
                    "Encrypted message  by DES : "+DEScipher);
            System.out.println("Decrypting ciphertext with key: 'secretkey'\nDecrypted Plaintext:");
        startTime = System.nanoTime();

        String plain = des.DESdecrypt(keyDes, DEScipher);
        estimatedTime = System.nanoTime() - startTime;
        System.out.println("DES decrypting time in nanoseconds : " + estimatedTime);
        System.out.println("DSA decrypted : " + plain);*/
